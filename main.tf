...
module "iam" {
  ...
  iam_policy_arn_CloudWatchLogPolicy     = module.policies.iam_policy_arn_CloudWatchLogPolicy
  iam_policy_arn_CloudWatchMetricsPolicy = module.policies.iam_policy_arn_CloudWatchMetricsPolicy
